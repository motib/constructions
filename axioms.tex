...
We have selected five points $p_i$, $i=1,\ldots,5$ on the parabola. Each point $p_i$ is at a distance of $a_i$ from both the focus and from the directrix. Drop a perpendicular from $p_1$ to the directrix and let $p'$ be its intersection with the directrix. Since $p_1$ is on the parabola, $\overline{p'p_1}=\overline{p_1p}=a_1$. We claim that the tangent $l$ to the parabola at $p_1$ (dashed line) is a fold that reflects $p$ onto $p'$.
